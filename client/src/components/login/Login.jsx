                        ...
                        <div className="card w-90  p-4">
                            <div className="card-body">
                                ...
                                <div className="float-end mt-3">
                                    ...
                                    <span>
                                        <Link className="text-center fs-6 h6 animated fadeInUp" to="/Registration">Sign Up</Link>
                                        <span className="ms-1">|</span>
                                        <Link className="text-center fs-6 h6 animated fadeInUp" to="/SendOTP"> Forget Password</Link>
                                    </span>
